...
void _pinHighFrequency(const int pin, const long frequency) {
  ...
  // else set the 4kHz
  if(frequency >= (0.5*(_PWM_FREQUENCY_MAX-_PWM_FREQUENCY_MIN))) { high_fq=true; } // TLD order of operations check
  //  High PWM frequency
  ...
  if((pin == 13) || (pin == 4)  ) { // TLD order of operations check
  ...
  } else if((pin == 12) || (pin == 11) ) { // TLD order of operations check
  ...
  } else if((pin == 5) || (pin == 3) || (pin == 2)) { // TLD order of operations check
  ...
  } else if((pin == 8) || (pin == 7) || (pin == 6)) { // TLD order of operations check
  ...
  } else if((pin == 44) || (pin == 45) || (pin == 46)) { // TLD order of operations check
...
void* _configure1PWM(long pwm_frequency,const int pinA) {
  if((!pwm_frequency) || (!_isset(pwm_frequency)) ) { pwm_frequency = _PWM_FREQUENCY; } // default frequency 32kHz // TLD order of operations check
...
int _configureComplementaryPair(const int pinH,const int pinL, long frequency) {
  ...
  // configure pin pairs
  if( ((pinH == 4) && (pinL == 13) ) || ((pinH == 13) && (pinL == 4) ) ) { // TLD order of operations check
  ...
  } else if( ((pinH == 11) && (pinL == 12) ) || ((pinH == 12) && (pinL == 11) ) ) { // TLD order of operations check
    // set frequency
    if(high_fq) { TCCR1B = ((TCCR1B & 0b11110000) | 0x01); } // set prescaler to 1 - 32kHz
    else { TCCR1B = ((TCCR1B & 0b11110000) | 0x02); } // set prescaler to 2 - 4kHz
    // configure complementary pwm on low side
  ...
  } else if(((pinH == 10) && (pinL == 9) ) || ((pinH == 9) && (pinL == 10) ) ) { // TLD order of operations check
    // set frequency
    if(high_fq) { TCCR2B = ((TCCR2B & 0b11110000) | 0x01); } // set prescaler to 1 - 32kHz
    else { TCCR2B = ((TCCR2B & 0b11110000) | 0x02); } // set prescaler to 2 - 4kHz
    // configure complementary pwm on low side
  ...
  } else if(((pinH == 5) && (pinL == 2) ) || ((pinH == 2) && (pinL == 5) ) ) { // TLD order of operations check
    // set frequency
    if(high_fq) { TCCR3B = ((TCCR3B & 0b11110000) | 0x01); } // set prescaler to 1 - 32kHz
    else { TCCR3B = ((TCCR3B & 0b11110000) | 0x02); } // set prescaler to 2 - 4kHz
    // configure complementary pwm on low side
  ...
  } else if(((pinH == 6) && (pinL == 7) ) || ((pinH == 7) && (pinL == 6) ) ) { // TLD order of operations check
    // set frequency
    if(high_fq) { TCCR4B = ((TCCR4B & 0b11110000) | 0x01); } // set prescaler to 1 - 32kHz
    else { TCCR4B = ((TCCR4B & 0b11110000) | 0x02); } // set prescaler to 2 - 4kHz
    // configure complementary pwm on low side
  ...
  } else if(((pinH == 46) && (pinL == 45) ) || ((pinH == 45) && (pinL == 46) ) ) { // TLD order of operations check
    // set frequency
    if(high_fq) { TCCR5B = ((TCCR5B & 0b11110000) | 0x01); } // set prescaler to 1 - 32kHz
    else { TCCR5B = ((TCCR5B & 0b11110000) | 0x02); } // set prescaler to 2 - 4kHz
    // configure complementary pwm on low side
