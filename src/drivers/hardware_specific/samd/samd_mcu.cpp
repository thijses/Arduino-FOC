...
bool attachTCC(tccConfiguration& tccConfig) {
  #warning("this code is written real weird, please check!") // TLD added warning, because the code below is too strange to ignore
...
bool checkPeripheralPermutationSameTCC6(tccConfiguration& pinAh, tccConfiguration& pinAl, tccConfiguration& pinBh, tccConfiguration& pinBl, tccConfiguration& pinCh, tccConfiguration& pinCl) {
  ...
  if((pinAh.tcc.tccn<0) || (pinAh.tcc.tccn!=pinAl.tcc.tccn) || (pinAh.tcc.tccn!=pinBh.tcc.tccn) || (pinAh.tcc.tccn!=pinBl.tcc.tccn)
    || (pinAh.tcc.tccn!=pinCh.tcc.tccn) || (pinAh.tcc.tccn!=pinCl.tcc.tccn) || (pinAh.tcc.tccn>=TCC_INST_NUM)) { // TLD order of operations check
    return(false);
  }

  if((pinAh.tcc.chan==pinBh.tcc.chan) || (pinAh.tcc.chan==pinBl.tcc.chan) || (pinAh.tcc.chan==pinCh.tcc.chan) || (pinAh.tcc.chan==pinCl.tcc.chan)) { // TLD order of operations check
    return(false);
  }
  if((pinBh.tcc.chan==pinCh.tcc.chan) || (pinBh.tcc.chan==pinCl.tcc.chan)) { // TLD order of operations check
    return(false);
  }
  if((pinAl.tcc.chan==pinBh.tcc.chan) || (pinAl.tcc.chan==pinBl.tcc.chan) || (pinAl.tcc.chan==pinCh.tcc.chan) || (pinAl.tcc.chan==pinCl.tcc.chan)) { // TLD order of operations check
    return(false);
  }
  if((pinBl.tcc.chan==pinCh.tcc.chan) || (pinBl.tcc.chan==pinCl.tcc.chan)) { // TLD order of operations check
    return(false);
  }

  if((pinAh.tcc.chan!=pinAl.tcc.chan) || (pinBh.tcc.chan!=pinBl.tcc.chan) || (pinCh.tcc.chan!=pinCl.tcc.chan)) { // TLD order of operations check
    return(false);
  }
  if((pinAh.wo==pinAl.wo) || (pinBh.wo==pinBl.wo) || (pinCh.wo!=pinCl.wo)) { // TLD order of operations check
    return(false);
  }
...
bool checkPeripheralPermutationCompatible6(tccConfiguration& pinAh, tccConfiguration& pinAl, tccConfiguration& pinBh, tccConfiguration& pinBl, tccConfiguration& pinCh, tccConfiguration& pinCl) {
  ...
  if((pinAh.tcc.tccn<0) || (pinAl.tcc.tccn<0) || (pinBh.tcc.tccn<0) || (pinBl.tcc.tccn<0) || (pinCh.tcc.tccn<0) || (pinCl.tcc.tccn<0)) { // TLD order of operations check
    return(false);
  }
  // only TCC units for 6-PWM
  if((pinAh.tcc.tccn>=TCC_INST_NUM) || (pinAl.tcc.tccn>=TCC_INST_NUM) || (pinBh.tcc.tccn>=TCC_INST_NUM)
      || (pinBl.tcc.tccn>=TCC_INST_NUM) || (pinCh.tcc.tccn>=TCC_INST_NUM) || (pinCl.tcc.tccn>=TCC_INST_NUM)) { // TLD order of operations check
    return(false);
  }
  ...
  if((pinAh.tcc.chaninfo==pinBh.tcc.chaninfo) || (pinAh.tcc.chaninfo==pinBl.tcc.chaninfo) || (pinAh.tcc.chaninfo==pinCh.tcc.chaninfo) || (pinAh.tcc.chaninfo==pinCl.tcc.chaninfo)) { // TLD order of operations check
    return(false);
  }
  if((pinAl.tcc.chaninfo==pinBh.tcc.chaninfo) || (pinAl.tcc.chaninfo==pinBl.tcc.chaninfo) || (pinAl.tcc.chaninfo==pinCh.tcc.chaninfo) || (pinAl.tcc.chaninfo==pinCl.tcc.chaninfo)) { // TLD order of operations check
    return(false);
  }
  if((pinBh.tcc.chaninfo==pinCh.tcc.chaninfo) || (pinBh.tcc.chaninfo==pinCl.tcc.chaninfo)) { // TLD order of operations check
    return(false);
  }
  if((pinBl.tcc.chaninfo==pinCh.tcc.chaninfo) || (pinBl.tcc.chaninfo==pinCl.tcc.chaninfo)) { // TLD order of operations check
    return(false);
  }

  // check H/L pins are on same timer
  if((pinAh.tcc.tccn!=pinAl.tcc.tccn) || (pinBh.tcc.tccn!=pinBl.tcc.tccn) || (pinCh.tcc.tccn!=pinCl.tcc.tccn)) { // TLD order of operations check
    return(false);
  }
